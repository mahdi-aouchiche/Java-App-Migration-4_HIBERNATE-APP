 ...
 */
@WebServlet("/view-average-salary-by-department")
public class ViewAverageSalaryByDepartment extends HttpServlet {
	...
	protected void doGet(
		...
		String message = "Department's Average Salary";
		...
		request.getRequestDispatcher("WEB-INF/views/view-average-salary-by-department.jsp")
			   .forward(request, response);
	}
}
